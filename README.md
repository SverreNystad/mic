...
![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/CogitoNTNU/mic/ci.yml)
![GitHub top language](https://img.shields.io/github/languages/top/CogitoNTNU/mic)
![GitHub language count](https://img.shields.io/github/languages/count/CogitoNTNU/mic)
...
1. **Clone the repository**:
   ...
   ```sh
   git clone https://github.com/CogitoNTNU/mic.git
   cd mic
   ```
